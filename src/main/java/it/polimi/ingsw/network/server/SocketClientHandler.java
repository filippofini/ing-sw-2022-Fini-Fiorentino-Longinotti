...
/**
 * Socket implementation of ClientHandler interface.
 */
public class SocketClientHandler implements ClientHandler, Runnable {
    ...
    /**
     * This method manages the connection of a new client and keep listening to the socket for new messages.
     *
                ...
                synchronized (inputLock) {
                    ...
                    if (message != null && message.getMessageType() != MessageType.PING) {
                        if (message.getMessageType() == MessageType.LOGIN_REQUEST) {
                            socketServer.addClient(message.getName(), this);
                        } else {
    ...
    /**
     * This method returns the current status of the connection.
     *
    ...
    /**
     * This method sends a message to the client via socket.
     *
