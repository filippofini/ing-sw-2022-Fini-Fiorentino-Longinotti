 ...
 */
public enum MessagesConnection {
    PING ("Ping"),
    TIMER_EXPIRED ("Timer has expired"),
    CONNECTION_CLOSED ("Connection closed"),
    INSERT_EXPERT_MODE ("Do you want to play in expert mode?  y|n"),
    INSERT_NAME("Insert name"),
    INVALID_NICKNAME ("Your nickname was invalid, be sure to insert only valid characters (A-Z, a-z, 0-9)"),
    ...
    MessagesConnection(String message){
